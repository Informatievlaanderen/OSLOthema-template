...
Dit bestand bevat instructies voor de **_editor(s)_** van dit thema en heeft als doel beschikbaar te zijn op de `master` branch.
...
Doe dit bijvoorbeeld meteen voor de titel van dit README.md bestand op de `master` branch.
